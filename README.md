...
- [Combine Functions into Class(여러 함수를 클래스로 묶기)](https://github.com/kmlee78/refactoring/blob/main/basic_skills/combine_functions_into_class.js)
- [Combine Functions into Transform(여러 함수를 변환 함수로 묶기)](https://github.com/kmlee78/refactoring/blob/main/basic_skills/combine_functions_into_transform.js)
...
- [Replace Temp with Query(임시 변수를 질의 함수로 바꾸기)](https://github.com/kmlee78/refactoring/blob/main/encapsulation/replace_temp_with_query.js)
- [Extract Class(클래스 추출하기)](https://github.com/kmlee78/refactoring/blob/main/encapsulation/extract_class.js)
